...
ExecuteWithTryCatch | Func<T\> func | Result<T\>
ExecuteWithTryCatchAsync | Func<Task\> func | Task<Exception\>
ExecuteWithTryCatchAsync<T\> | Func<Task<T\>\> func | Task<Result<T\>\>
...
**Utils.RandomString** by default returns a string consisting of the following characters: ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789
