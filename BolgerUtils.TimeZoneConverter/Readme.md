...
A **TimeZoneInfo** instance can be referenced by using a timezone's system name or via the **SystemTimeZoneInfoID** enum.
...
```csharp
var timeZone = Utils.GetTimeZone("AUS Eastern Standard Time");
```
